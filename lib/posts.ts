...
export const posts: Post[] = [
  {
    slug: "best-places-outdoor-yoga-college-station",
    title: "The Best Places for Outdoor Yoga in College Station, TX",
    description:
      "Discover the top parks, trails, and open spaces for outdoor yoga in College Station and Bryan, TX — from Lick Creek Park to the Texas A&M campus grounds.",
    publishedAt: "2026-03-10",
    readingTime: "5 min read",
    category: "Local Guide",
    excerpt:
      "College Station has more green space than you'd expect from a university town. Here are the spots locals use to get their practice in — with or without a mat.",
    body: `
...
For those who want the benefits of a personalized practice without braving the elements, our **in-home private sessions** bring a certified instructor directly to your College Station or Bryan address — year round, climate controlled.
  ...
  {
    slug: "tech-neck-yoga-poses-tamu-remote-workers",
    title: "Relieving 'Tech Neck': 5 Yoga Poses for Texas A&M Students and Remote Workers",
    description:
    ...
    excerpt:
      "Whether you're in a library study cubicle at Evans or working remote from your Northgate apartment, 'tech neck' is real. Here's how to fix it in under 15 minutes.",
    body: `
...
We offer **private concierge coaching** across College Station and Bryan — your home, your schedule, your specific body.
  ...
  {
    slug: "game-day-yoga-college-station",
    title: "The Ultimate Aggie Game Day Reset: Why Your Tailgate Needs a Private Yoga Session",
    description:
    ...
    category: "Game Day",
    excerpt:
      "Kyle Field Saturdays are legendary — and physically brutal. Here's why the savviest Aggie groups are booking a private yoga session at their rental before the cannon fires.",
    body: `
...
Gig 'em.
  ...
  {
    slug: "mobile-yoga-moving-bryan-college-station",
    title: "Why Mobile Yoga is the Secret to Stress-Free Moving in Bryan/College Station",
    description:
      "Moving is one of the most physically and mentally stressful life events. Here's how mobile yoga coaching helps Bryan and College Station residents protect their bodies and minds during a move.",
    publishedAt: "2026-03-24",
    readingTime: "4 min read",
    category: "Community",
    excerpt:
      "Between lifting boxes, sleeping on air mattresses, and the chaos of unpacking, moving tears your body apart. Mobile yoga is the antidote — and it meets you where you are.",
    body: `
...
If you're in the middle of a move or planning one in College Station or Bryan, reach out to schedule a session. We'll build around your timeline and keep your body in the game.
  ...
  {
    slug: "sports-yoga-injury-prevention-college-station",
    title: "The Science of Availability: Why Yoga & Pilates Are the Missing Links in Aggie Athletic Performance",
    description:
      "Injury prevention, accelerated recovery, and rotational power for Aggie athletes — led by a former TAMU Anatomy Lab Instructor with MS Biology & Public Health.",
    publishedAt: "2026-03-28",
    readingTime: "9 min read",
    category: "Athletic Performance",
    excerpt:
      "Lauren Whitehead doesn't teach yoga. She teaches anatomy — applied at the speed of sport. Here's the physiology behind why functional movement science belongs in every Aggie training block.",
    body: `
...
Request a Biomechanical Mobility Audit at our Athletics page. We'll respond within one business day with availability and a program proposal built around your sport, your roster, and your training calendar.
  ...
  {
    slug: "prenatal-yoga-postpartum-recovery-college-station",
    title: "Beyond the Bump: The Clinical Benefits of Pre and Postnatal Yoga in Aggieland",
    description:
    ...
    excerpt:
      "Pregnancy is one of the most significant biomechanical events a body can experience. Lauren Whitehead — MS Biology, MS Public Health, former TAMU Anatomy Lab Instructor — builds prenatal and postnatal programs around your specific body, not a population average.",
    body: `
