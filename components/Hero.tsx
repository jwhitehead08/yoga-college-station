...
const segments = [
  {
    ...
    sub: "Tailored yoga, pilates, mobility and recovery sessions in your College Station or Bryan home. Built around your body, your goals, your schedule.",
    ...
    sub: "Tailored yoga, pilates, mobility and recovery sessions for your friend group, office, or athletic team.",
    cta: "Check Availability",
    href: "#events",
    iconBg: "bg-amber-500",
